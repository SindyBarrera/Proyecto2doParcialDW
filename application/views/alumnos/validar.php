			...
			<div class="card-header">
				...
				<form method="POST">
					...
					<div class="d-flex justify-content-center links">
						...
						<input type="submit" value="Validar" class="btn float-right login_btn" href="http://3.144.78.104/crud/index.php/login" >
					</div>
					<div class="d-flex justify-content-right links">
				<a href="http://3.144.78.104/crud/index.php/login">Ir a Inicio de sesión</a>
				</div>
				</form>
				</div>
